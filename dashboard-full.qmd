...
report_txt <- function(N, X, a, b, confidence = 0.9) {
  ...
  glue(
    ...
    "of there being a noticeable sensory difference in these two samples is ", "between a minimum of {round(100*lims[1], 0)}% and a maximum of {round(100*lims[2], 0)}%, ",
...
![Two participants taste wine in a sensory test](images/sensory-evaluation.jpeg){width=500}
