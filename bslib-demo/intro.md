# So you want to run a sensory test
...
You'll notice 3 of tabs in this toolkit--if you follow through each of them, you'll learn how to design a test, how to collect data, and how to analyze the data using this toolkit.  If you're already familiar with these kinds of tests, and you just want to analyze data you've already collected, you can skip right to the "discrimination test analysis" tab above or by clicking <font color="red">here</font>.
